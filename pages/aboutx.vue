        ...
        <div class="content-section">
          ...
          <div class="members-grid">
            <div v-for="member in members" :key="member.github" class="member-card">
              ...
              <h3>{{ member.name }}</h3>
              <p class="member-role">{{ member.role[$i18n.locale] }}</p>
              <p class="member-description">{{ member.description[$i18n.locale] }}</p>
              <a :href="`https://github.com/${member.github}`" target="_blank" rel="noopener" class="github-link">
